 ...
 *       &lt;attribute name="property" use="required" type="{http://www.w3.org/2001/XMLSchema}string" fixed="pred:je_dobrovoljni_davalac_krvi" /&gt;
...
public class DobrovoljniDavalacKrvi {
    ...
    public String getProperty() {
        if (property == null) {
            return "pred:je_dobrovoljni_davalac_krvi";
        } else {
            return property;
        }
    }
