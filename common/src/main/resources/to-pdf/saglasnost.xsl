...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                xmlns:sagl="http://www.ftn.uns.ac.rs/saglasnost/"
            ...
            <fo:page-sequence master-reference="saglasnost">
                ...
                <fo:flow flow-name="xsl-region-body">
                    ...
                    <fo:block font-family="sans-serif" font-size="12px" padding="5px" margin-top="10px">
                        ...
                        <xsl:if test="//sagl:srpsko_drzavljanstvo">
                            <fo:inline font-weight="bold">
                                <xsl:value-of select="concat(' ', //sagl:srpsko_drzavljanstvo/sagl:jmbg)"/>
                            </fo:inline>
                        </xsl:if>
                    </fo:block>
                    <fo:block font-family="sans-serif" font-size="12px" padding="5px" text-indent="85px">
                        ...
                        <xsl:if test="//sagl:strano_drzavljanstvo">
                            <fo:inline font-weight="bold">
                                <xsl:value-of select="concat(' ', //sagl:naziv_stranog_drzavljanstva, ' ')"/>
                            </fo:inline>
                        </xsl:if>
                        | Br. pasosa
                        <xsl:if test="//sagl:strano_drzavljanstvo">
                            <fo:inline font-weight="bold">
                                <xsl:value-of select="concat(' ', //sagl:broj_pasosa_ili_ebs, ' ')"/>
                            </fo:inline>
                        </xsl:if>
                    </fo:block>
                    <fo:block font-family="sans-serif" font-size="12px" padding="5px">
                        ...
                        <fo:inline>
                            <xsl:value-of select="concat(' ', //sagl:ime_prezime, ' | ')"/>
                        </fo:inline>
                        <fo:inline font-weight="bold">Ime roditelja</fo:inline>
                        <fo:inline>
                            <xsl:value-of select="concat(' ', //sagl:ime_roditelja)"/>
                        </fo:inline>
                    </fo:block>
                    <fo:block font-family="sans-serif" font-size="12px" padding="5px">
                        <fo:inline font-weight="bold">Pol:</fo:inline>
                        <fo:inline>
                            <xsl:value-of select="concat(' ', //sagl:pol, ' | ')"/>
                        </fo:inline>
                        <fo:inline font-weight="bold">Datum rodjenja</fo:inline>
                        <fo:inline>
                            <xsl:value-of select="concat(' ', //sagl:datum_rodjenja, ' | ')"/>
                        </fo:inline>
                        <fo:inline font-weight="bold">Mesto rodjenja</fo:inline>
                        <fo:inline>
                            <xsl:value-of select="concat(' ', //sagl:mesto_rodjenja)"/>
                        </fo:inline>
                    </fo:block>
                    <fo:block font-family="sans-serif" font-size="12px" padding="5px">
                        <fo:inline font-weight="bold">Adresa (ulica i broj)</fo:inline>
                        <fo:inline>
                            <xsl:value-of select="concat(' ', //sagl:prebivaliste/sagl:ulica, ' ', //sagl:prebivaliste/sagl:broj, ' | ')"/>
                        </fo:inline>
                        <fo:inline font-weight="bold">Mesto/Naselje</fo:inline>
                        <fo:inline>
                            <xsl:value-of select="concat(' ', //sagl:prebivaliste/sagl:mesto)"/>
                        </fo:inline>
                    </fo:block>
                    <fo:block font-family="sans-serif" font-size="12px" padding="5px">
                        <fo:inline font-weight="bold">Opstina/Grad</fo:inline>
                        <fo:inline>
                            <xsl:value-of select="concat(' ', //sagl:prebivaliste/sagl:opstina, ' | ')"/>
                        </fo:inline>
                        <fo:inline font-weight="bold">Tel. fiksni</fo:inline>
                        <fo:inline>
                            <xsl:value-of select="concat(' ', //sagl:fiksni_telefon)"/>
                        </fo:inline>
                    </fo:block>
                    <fo:block font-family="sans-serif" font-size="12px" padding="5px">
                        <fo:inline font-weight="bold">Tel. mobilni</fo:inline>
                        <fo:inline>
                            <xsl:value-of select="concat(' ', //sagl:mobilni_telefon, ' | ')"/>
                        </fo:inline>
                        <fo:inline font-weight="bold">email</fo:inline>
                        <fo:inline>
                            <xsl:value-of select="concat(' ', //sagl:email_adresa)"/>
                        </fo:inline>
                    </fo:block>
                    <fo:block font-family="sans-serif" font-size="12px" padding="5px">
                        <fo:inline font-weight="bold">Radni status:</fo:inline>
                        <fo:inline>
                            <xsl:value-of select="concat(' ', //sagl:radni_status)"/>
                        </fo:inline>
                    </fo:block>
                    <fo:block font-family="sans-serif" font-size="12px" padding="5px">
                        <fo:inline font-weight="bold">Zanimanje zaposlenog:</fo:inline>
                        <fo:inline>
                            <xsl:value-of select="concat(' ', //sagl:zanimanje_zaposlenog)"/>
                        </fo:inline>
                    </fo:block>
                    <fo:block font-family="sans-serif" font-size="12px" padding="5px">
                        <fo:inline font-weight="bold">Korisnik ustanove soc. zast.</fo:inline>
                        <xsl:if test="//sagl:pacijent_koristi_zastitu/text() = true()">
                            <fo:inline>
                                Da
                            </fo:inline>
                        </xsl:if>
                        <xsl:if test="//sagl:pacijent_koristi_zastitu/text() = false()">
                            <fo:inline>
                                Ne
                            </fo:inline>
                        </xsl:if>
                        ...
                        <fo:inline>
                            <xsl:value-of select="concat(' ', //sagl:naziv_sedista, ' ', //sagl:opstina_sedista)"/>
                        </fo:inline>
                    </fo:block>
                    <fo:block font-family="sans-serif" font-size="12px" padding="5px">
                        <fo:inline font-weight="bold">Izjavljujem da: SAGLASAN SAM,</fo:inline>
                        <fo:inline>
                            sa sprovodjenjem aktivne/pasivne imunizacije (naziv imunoloskog leka):
                            <xsl:value-of select="concat(' ', //sagl:naziv_imunoloskog_leka)"/>
                        </fo:inline>
                    </fo:block>
                    ...
                    <xsl:if test="//sagl:evidencija_o_vakcinaciji">
                        ...
                        <fo:block font-family="sans-serif" font-size="12px" margin-bottom="5px">
                            ...
                            <fo:inline font-weight="bold">
                                <xsl:value-of select="concat(' ', //sagl:zdravstvena_ustanova/sagl:naziv, ' ')"/>
                            </fo:inline>
                            Vakcinacijski punkt
                            <fo:inline font-weight="bold">
                                <xsl:value-of select="concat(' ', //sagl:vakcinacijski_punkt)"/>
                            </fo:inline>
                        </fo:block>
                        <fo:block font-family="sans-serif" font-size="12px" margin-bottom="5px">
                            ...
                            <fo:inline font-weight="bold">
                                <xsl:value-of
                                        select="concat(' ', //sagl:informacije_o_lekaru/sagl:ime, ', ', //sagl:informacije_o_lekaru/sagl:prezime, ', ', //sagl:informacije_o_lekaru/sagl:broj_telefona)"/>
                            </fo:inline>
                        </fo:block>
                        <fo:block font-family="sans-serif" font-size="12px" margin-bottom="5px">
                        ...
                        <fo:block font-size="10px">
                            <fo:table font-family="serif" margin="5px auto 5px auto" border="1px">
                                ...
                                <fo:table-body>
                                    ...
                                    <xsl:for-each select="//sagl:izvrsena_imunizacija/sagl:vakcina">
                                        <fo:table-row border="1px solid darkgrey">
                                            <fo:table-cell padding="2px">
                                                <fo:block>
                                                    <xsl:value-of select="sagl:naziv"/>
                                                </fo:block>
                                            </fo:table-cell>
                                            <fo:table-cell padding="2px">
                                                <fo:block>
                                                    <xsl:value-of select="sagl:datum_davanja"/>
                                                </fo:block>
                                            </fo:table-cell>
                                            <fo:table-cell padding="2px">
                                                <fo:block>
                                                    <xsl:value-of select="sagl:nacin_davanja"/>
                                                </fo:block>
                                            </fo:table-cell>
                                            <fo:table-cell padding="2px">
                                                <fo:block>
                                                    <xsl:value-of select="sagl:ekstremitet"/>
                                                </fo:block>
                                            </fo:table-cell>
                                            <fo:table-cell padding="2px">
                                                <fo:block>
                                                    <xsl:value-of select="sagl:serija"/>
                                                </fo:block>
                                            </fo:table-cell>
                                            <fo:table-cell padding="2px">
                                                <fo:block>
                                                    <xsl:value-of select="sagl:proizvodjac"/>
                                                </fo:block>
                                            </fo:table-cell>
                                            <fo:table-cell padding="2px">
                                                <fo:block>
                                                    <xsl:value-of select="sagl:nezeljena_reakcija"/>
                                                </fo:block>
                                            </fo:table-cell>
                                        </fo:table-row>
                                    </xsl:for-each>
